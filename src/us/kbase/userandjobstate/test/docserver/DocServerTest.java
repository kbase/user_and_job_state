package us.kbase.userandjobstate.test.docserver;
...
import us.kbase.userandjobstate.docserver.DocServer;

public class DocServerTest {
	
	//TODO DOCSERV move to common
...
//	private static CloseableHttpClient client = HttpClients.createDefault();
	...
	public void serverNameNull() throws Exception {
		checkStartup(null, "DocServ",
				"/us/kbase/userandjobstate/test/docserver", IDX1_CONTENTS);
	}
	
	@Test
	public void serverNameEmpty() throws Exception {
		checkStartup("", "DocServ", "/us/kbase/userandjobstate/test/docserver",
				IDX1_CONTENTS);
	}
	...
	public void docsLocNull() throws Exception {
		DocServer.setDefaultDocsLocation(
				"/us/kbase/userandjobstate/test/docserver/files");
	...
	public void docsLocNoSlash() throws Exception {
		checkStartup("WhooptyWoo", "WhooptyWoo",
				"us/kbase/userandjobstate/test/docserver/files", IDX2_CONTENTS);
	}
	...
	private String checkMessage(String message, ExpectedLog exp) {
		...
		assertThat("caller correct", headerParts[4],
				is("us.kbase.userandjobstate.docserver.DocServer"));
		//5 is pid
